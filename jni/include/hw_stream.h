...
class net_udp_file_stream
    :public stream_post
	,public boost::noncopyable
{
public:
	net_udp_file_stream(server_ref server,int slot,int stream,rec_file_t* file_info);
	virtual ~net_udp_file_stream();
...
typedef boost::shared_ptr<net_udp_file_stream> net_udp_file_stream_ref;
