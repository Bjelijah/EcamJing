...
//	} 
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem, int visibleItemCount,
		...
		if(totalItemCount > visibleItemCount){
			//�еڶ�ҳ
			//mIsLast = true;
			Log.e("123", "foot view show");
			footView.setVisibility(View.VISIBLE);
		}else{
			//mIsLast = false;
			Log.e("123", "foot view gone");
...
//				Log.i("123", "action down");
				if (firstItemIndex == 0 && !isRecored) {
					isRecored = true;
					startY = (int) event.getY();
					Log.v(TAG, "��downʱ���¼��ǰλ�á�");
					Log.v("123", "acton_down");
				}
				break;
...
//				Log.i("123", "action up");
				if (state != REFRESHING && state != LOADING) {
					...
					if (state == PULL_To_REFRESH) {
						...
						Log.i("123", "action up pull to refresh");
					}
					if (state == RELEASE_To_REFRESH) {
						...
						Log.i("123", "action up release to refresh");
					}
				}
